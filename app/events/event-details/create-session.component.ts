...
export class CreateSessionComponenet implements OnInit{
    ...
    ngOnInit(): void {
        ...
        this.abstract = new FormControl('', [Validators.required, Validators.maxLength(400), restrictedWords(['foo', 'too'])]);
